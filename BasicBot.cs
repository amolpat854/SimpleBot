...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class BasicBot : IBot
    {
        ...
        /// </summary>
        public static readonly string LuisConfiguration = "AmolTestBot2-8c3f";

        private readonly IStatePropertyAccessor<EnquiryState> _greetingStateAccessor;
        ...
        public BasicBot(BotServices services, UserState userState, ConversationState conversationState, ILoggerFactory loggerFactory)
        {
            ...
            _greetingStateAccessor = _userState.CreateProperty<EnquiryState>(nameof(EnquiryState));
        ...
        private async Task UpdateGreetingState(RecognizerResult luisResult, ITurnContext turnContext)
        {
            if (luisResult.Entities != null && luisResult.Entities.HasValues)
            {
                ...
                var greetingState = await _greetingStateAccessor.GetAsync(turnContext, () => new EnquiryState());
                ...
                foreach (var name in userNameEntities)
                {
                    ...
                    if (entities[name] != null)
                    {
                        ...
                        greetingState.EnquiryType = char.ToUpper(newName[0]) + newName.Substring(1);
                        break;
                    }
                }
                ...
                foreach (var city in userLocationEntities)
                {
                    if (entities[city] != null)
                    {
                        ...
                        greetingState.FlightNumber = char.ToUpper(newCity[0]) + newCity.Substring(1);
                        break;
                    }
                }
